...
const Studio1 = () => {
  return (
    <div className="flex flex-col items-center w-full min-h-screen bg-black p-4 sm:p-6 lg:p-8 gap-4 sm:gap-6 lg:gap-8 overflow-x-hidden">
      
      {/* Title Section */}
      <h1 className="text-white text-4xl sm:text-[10rem] font-bold text-center mb-0">
        THE TEAM
      </h1>
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between w-full">
        ...
        {/* Rotating Cube - Hidden on Mobile */}
        <div className="hidden sm:flex w-full lg:w-2/5 items-center justify-center order-1 lg:order-2 my-4 sm:my-6 lg:my-8">
          <motion.div
